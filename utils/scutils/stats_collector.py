...
class StatsCollector(object):
    ...
    @classmethod
    def get_time_window(cls, redis_conn=None, host='localhost', port=6379,
        ...
        @param keep_max: If rolling the static window, the max number of prior
            windows to keep
        """
    ...
    @classmethod
    def get_rolling_time_window(cls, redis_conn=None, host='localhost',
    ...
    @classmethod
    def get_counter(cls, redis_conn=None, host='localhost', port=6379,
    ...
    @classmethod
    def get_unique_counter(cls, redis_conn=None, host='localhost', port=6379,
    ...
    @classmethod
    def get_hll_counter(cls, redis_conn=None, host='localhost', port=6379,
    ...
    @classmethod
    def get_bitmap_counter(cls, redis_conn=None, host='localhost', port=6379,
