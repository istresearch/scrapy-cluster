...
There are a number of different options available to set up Scrapy Cluster. You can chose to provision with the `Docker Quickstart`_, or manually configure via the `Cluster Quickstart`_ yourself.
